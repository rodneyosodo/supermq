...
func (urm userRepositoryMiddleware) RetrieveAll(ctx context.Context, state string, offset, limit uint64, ids []string, email string, um users.Metadata) (users.UserPage, error) {
