...
func (urm *userRepositoryMock) RetrieveAll(ctx context.Context, active string, offset, limit uint64, ids []string, email string, um users.Metadata) (users.UserPage, error) {
	urm.mu.Lock()
	defer urm.mu.Unlock()
