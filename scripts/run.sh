...
# Things
###
MF_THINGS_LOG_LEVEL=info MF_THINGS_HTTP_PORT=9001 MF_THINGS_AUTH_GRPC_PORT=7000 MF_THINGS_AUTH_HTTP_PORT=9002 $BUILD_DIR/mainflux-things &

###
# HTTP
###
MF_HTTP_ADAPTER_LOG_LEVEL=info MF_HTTP_ADAPTER_PORT=8185 MF_THINGS_AUTH_GRPC_URL=localhost:7000 $BUILD_DIR/mainflux-http &
