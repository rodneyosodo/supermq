...
var (
	// ErrBearerToken indicates missing or invalid bearer client token.
	ErrBearerToken = errors.New("missing or invalid bearer client token")
	...
	// ErrInvalidStatus indicates that an invalid status.
