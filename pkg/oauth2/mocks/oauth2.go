...
// Profile provides a mock function with given fields: ctx, code
func (_m *Provider) Profile(ctx context.Context, code string) (clients.Client, xoauth2.Token, error) {
