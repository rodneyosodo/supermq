...
func (sdk mfSDK) IssueCert(token, thingID string, keyBits int, keyType, valid string) (Cert, error) {
	var c Cert
	r := certReq{
		ThingID: thingID,
		KeyBits: keyBits,
...
func (sdk mfSDK) RemoveCert(token, id string) error {
...
func (sdk mfSDK) RevokeCert(token, thingID, certID string) error {
